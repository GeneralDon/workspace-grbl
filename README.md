# com-chilipeppr-workspace-pbggrbl
A ChiliPeppr Workspace grbl for PBG.



## ChiliPeppr Workspace / pbggrbl
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-pbggrbl |
| Name                  | Workspace / pbggrbl |
| Description           | A ChiliPeppr Workspace grbl for PBG. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/GeneralDon/workspace-pbggrbl/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/generaldon/pbggrbl |
| Github URL            | http://github.com/GeneralDon/workspace-pbggrbl |
| Test URL              | https://preview.c9users.io/generaldon/pbggrbl/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/GeneralDon/workspace-pbggrbl/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-pbggrbl"], // the id you gave your workspace
      function(myWorkspacePbggrbl) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / pbggrbl just got loaded.", myWorkspacePbggrbl);
        myWorkspacePbggrbl.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-pbggrbl"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / pbggrbl"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace grbl for PBG."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/GeneralDon/workspace-pbggrbl/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/generaldon/pbggrbl"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/GeneralDon/workspace-pbggrbl"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://pbggrbl-generaldon.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
