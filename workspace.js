...
cprequire_test(["inline:com-chilipeppr-workspace-pbggrbl"], function(ws) {
    ...
    $('title').html("PBG grbl Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-pbggrbl", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-pbggrbl", // Make the id the same as the cpdefine id
        name: "Workspace / pbggrbl", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace grbl for PBG.`,
